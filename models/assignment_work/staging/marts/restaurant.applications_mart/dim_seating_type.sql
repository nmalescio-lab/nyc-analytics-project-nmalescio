   ...
   SELECT
       seating_interest_sidewalk AS seating_interest,
        ...
        CASE 
            ...
            ELSE FALSE
        END AS approved_for_roadway   --TODO: Replace this comment with a CASE WHEN .. statement that handles the different possibilities for approved_for_sidewalk_seating and approved_for_roadway_seating in the data
